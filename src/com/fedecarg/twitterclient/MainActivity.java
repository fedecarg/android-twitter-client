...
public class MainActivity extends Activity {
	...
	public void updateLoginStatus() {
		Toast.makeText(MainActivity.this,
				"Logged into Twitter : " + TwitterUtils.isAuthenticated(prefs),
	...
	public void sendTweet(String text) {
		 ...
		 * value = input.getText().toString().trim(); try {
		 * TwitterUtils.sendTweet(prefs,value);
		 * mTwitterHandler.post(mUpdateTwitterNotification); } catch (Exception
		 * e) { e.printStackTrace(); } } });
		 * 
